...
sr.reveal('.home__data, .about__img, .skills__subtitle, .skills__text', { interval: 200 }); 
sr.reveal('.home__img, .about__subtitle, .about__text, .skills__img', { delay: 400, interval: 200 }); 
